...
import Node from "neo-blessed/lib/widgets/node";

const Input = blessed.input;

const nextTick = global.setImmediate || process.nextTick.bind(process);

interface TextareaOptions extends blessed.Widgets.TextareaOptions {}

export function Textarea(this: any, options: TextareaOptions) {
  const self = this;

  if (!(this instanceof Node)) {
    return new (Textarea as any)(options);
  }
